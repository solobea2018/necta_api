...
if (isset($_GET['ajax']) && $_GET['ajax'] === '1') {
    ...
    $url = 'https://olas.heslb.go.tz/pgz/necta-pre-reg/get-f6-candidate-details/?index_no='. urlencode($indexNo);
...
<head>
    <meta charset="UTF-8">
    <title>ACSEE Results Portal</title>
...
<div class="container">
    ...
    <header>
        <h2>ACSEE Results Portal</h2>
        <p>Search Form Six candidate results</p>
    </header>
